        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              <a class="navbar-brand" href="">Test 151 2 - Classes</a>
            </div>
          ...
          <div class="panel panel-primary">
             ...
             <div class="panel-body">
                <form id="add_prd_form" action="check.php" method="post">
                  ...
                  <!-- Site web -->
                  <div class="form-group row">
                     <label for="url_prd" class="col-sm-2 col-form-label">Site web du fabricant</label>
                     <div class="col-sm-10">
                        <input type="text" class="form-control" id="url_prd"  name="url_prd" placeholder="Site web du fabricant">
                     </div>
                  </div>
